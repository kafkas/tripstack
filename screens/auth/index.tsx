...
let AuthScreen = ({
  ...
  // Combined progress
  const progress = signinProgress.status ? signinProgress : signupProgress;
  ...
  const submitDisabled =
    ...
    !StringUtil.isValidPassword(password);
          ...
          {[
            {
              ...
              loading: signinProgress.status === 'REQUEST',
            },
            {
              id: 'signup',
              label: 'Sign up',
              onPress: () => signupUser(email, password),
              loading: signupProgress.status === 'REQUEST',
            },
          ].map((b, i) => (
            <View key={i.toString()} style={styles.pageContainer}>
              <SubmitButton
                label={b.label}
                onPress={b.onPress}
...
AuthScreen = React.memo(AuthScreen);
